...
const spendingData = [
  { month: "Jan", spending: 3200, budget: 5000, savings: 1800 },
  { month: "Feb", spending: 4100, budget: 5000, savings: 900 },
  { month: "Mar", spending: 3600, budget: 5000, savings: 1400 },
  { month: "Apr", spending: 4800, budget: 5000, savings: 200 },
  { month: "May", spending: 3900, budget: 5000, savings: 1100 },
  { month: "Jun", spending: 4328, budget: 5000, savings: 672 },
];
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={spendingData}>
          ...
          <CartesianGrid strokeDasharray="3 3" stroke="hsl(160 20% 90%)" vertical={false} />
          <XAxis
            dataKey="month"
